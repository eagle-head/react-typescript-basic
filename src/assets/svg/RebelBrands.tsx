...
function SvgRebelBrands(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fab"
      data-icon="rebel"
      className="rebel-brands_svg__svg-inline--fa rebel-brands_svg__fa-rebel rebel-brands_svg__fa-w-16"
      viewBox="0 0 512 512"
      width="1em"
      height="1em"
      {...props}
...
const MemoSvgRebelBrands = React.memo(SvgRebelBrands);
export default MemoSvgRebelBrands;
